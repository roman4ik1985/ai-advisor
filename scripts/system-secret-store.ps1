...
$script:SystemSecretAllowedNames = @(
  ...
  'AI_ADVISOR_ANALYTICS_PROVIDER',
  'AI_ADVISOR_ANALYTICS_ENVIRONMENT',
  'POSTHOG_PROJECT_TOKEN',
  'POSTHOG_API_HOST',
  'AI_ADVISOR_ANALYTICS_PILOT_START',
  'AI_ADVISOR_ANALYTICS_PILOT_END',
  'AI_ADVISOR_ANALYTICS_SCHEMA_VERSION',
